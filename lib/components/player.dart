...
class PlayerComponent extends StatefulWidget {
  ...
  PlayerComponent({required this.book, required this.globalContext});
...
class _PlayerComponentState extends State<PlayerComponent> {
  ...
  void initState() {
    ...
    completionSubscription = audioPlayer.onPlayerComplete.listen((e) {
  ...
  play() async {
    ...
    final buildUrl =
        "$apiurl/getRedirected?url=${audio.url}";
                        ...
                        children: <Widget>[
                          ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:
                                  "$apiurl/cover?name=${widget.book.title}",
